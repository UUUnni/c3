...
public class WCSResponses {
    ...
    public static final String DIR = "../data/wcs/7/";
    public static final String FILE = DIR+"wcs7.csv.gz";
    ...
    public static void tally()
    {
        ...
        for (int i=0; i<dt.getRowCount(); ++i) {
            // get color chip
            Double L = dt.getDouble(i,0);
            Double a = dt.getDouble(i,1);
            Double b = dt.getDouble(i,2);
            LAB x = new LAB(L, a, b);
            String c = x.toString();
...
//        }
        ...
        Util.writeList(DIR+"terms.txt", terms);
